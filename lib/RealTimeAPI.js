...
let RealTimeAPI = /** @class */ (function () {
     ...
     */
    RealTimeAPI.prototype.callMethod = function (method, customId) {
        var params = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            params[_i - 1] = arguments[_i];
        }
        var id = customId || uuid_1.v4();
        this.sendMessage({
            msg: "method",
            method: method,
            id: id,
     ...
     * getSubscription
     */
    RealTimeAPI.prototype.getSubscription = function (streamName, streamParam, addEvent, customId) {
        var id = customId || uuid_1.v4();
